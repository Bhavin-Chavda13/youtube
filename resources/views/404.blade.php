...
<html>
	...
	<div class="wrap">
		...
		<div class="header">
			...
			<div class="top-nav">
				<ul>
					<li><a href="{{route('Youtube.index')}}">Home</a><p>My Frontpage</p></li>
					
					<li><a href="{{route('categories.index')}}">Categories</a><p>Be Ur Self</p></li>
					
					<li><a href="{{route('contact.index')}}">Contact</a><p>Leave Messages</p></li>
				</ul>
			</div>
			<div class="clear"> </div>
			<!----End-top-nav---->
		...
		<div class="right-content">
			<div class="popular">
				...
				<p><img src="videocss/images/l1.png" title="likes" /> 10,000</p>
				<div class="clear"> </div>
			</div>
			<div class="grid1">
					...
					<div class="Recent-Vodeos">
						<h3>Recent-Videos</h3>
						<div class="video1">
							<img src="videocss/images/r1.jpg" title="video2" />
						...
						<div class="video1 video2">
							<img src="videocss/images/r2.jpg" title="video2" />
							<span>Lorem ipsum dolor sit amet,</span>
							<p>s consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
							<div class="clear"> </div>
						</div>
		...
		<div class="footer">
				...
				<h4>Stay in touch on</h4>
						<ul class="social">
							<li><img src="videocss/images/facebook.png" title="facebook"><a href="#">Facebook</a></li>
							<li><img src="videocss/images/twitter.png" title="twitter"><a href="#">Twitter</a></li>
							<li><img src="videocss/images/gplus.png" title="google+"><a href="#">Google+</a></li>
						</ul>
				</div>
				<div class="clear"> </div>
			</div>
